...
## Corpus Check
- 65 files · ~89,831 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 940 nodes · 2668 edges · 48 communities (37 shown, 11 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 396 edges (avg confidence: 0.81)
...
Cohesion: 0.08
Nodes (124): android, Accounts, Categories, cycleDayOf(), dayLabel(), weekColumnOf(), canNotify(), AppearanceState (+116 more)

### Community 1 - "LedgerState"
Cohesion: 0.06
Nodes (24): DemoData, Account, AccountKind, Bank, Card, Cash, Savings, Wallet (+16 more)

### Community 2 - "MoneyViewModel"
Cohesion: 0.05
Nodes (11): Template, ForeignAmount, Factory, StateFlow, T, MoneyViewModel, SettingsWriteTest, com (+3 more)

### Community 3 - "Txn"
Cohesion: 0.07
Nodes (24): challengesFor(), leanRunChallenge(), medianOf(), spendByDay(), weekendChallenge(), csvCell(), ledgerCsv(), minorToDecimal() (+16 more)
...
Cohesion: 0.14
Nodes (8): Conversion, convertMinor(), divRound(), StateFlow, parseRatesJson(), Rates, RatesStore, RatesTest
...
### Community 8 - "Flow"
Cohesion: 0.27
Nodes (5): TxnWithDetails, Flow, In, Out, Transfer

### Community 9 - "Water.kt"
Cohesion: 0.14
Nodes (34): weekdayInitials(), BalanceTrace(), CashFlowGrid(), ColumnPair(), DepthGauge(), DueCalendar(), isDarkWorld(), Color (+26 more)
...
Cohesion: 0.15
Nodes (14): LedgerCsvTest (export round trip), No Date Picker When Logging, SQL Has A Floor (minSdk 26 SQLite), categoryScale() (eight-step cool scale), Signature: Hand-drawn Charts, Merchant Monogram, Logging Must Survive A Hurry, The 10-Second Logging Moment (+6 more)

### Community 15 - "MoneyApp.kt"
Cohesion: 0.07
Nodes (33): AppPrefs, StateFlow, ThemeMode, Dark, Light, System, dueLabel(), PeriodSettings (+25 more)
...
### Community 18 - "TxnDao"
Cohesion: 0.19
Nodes (6): TxnDao, MerchantMemoryEntity, SplitEntity, TagEntity, TxnEntity, YearMonth
...
### Community 23 - "Sheets.kt"
Cohesion: 0.31
Nodes (6): AnnotatedString, Money, MoneyDigits, OffsetMapping, TransformedText, VisualTransformation

### Community 29 - "Multi-Currency Conversion Policy"
Cohesion: 0.22
Nodes (10): NextDueTest (bill advancement), RatesTest (currency conversion), Only Two Permissions, Bills, Goals and Debts Read Currency From Their Account, Multi-Currency Conversion Policy, Accounts / Wallets (feature area 2), Bills and Subscriptions (feature area 4), Frankfurter API (FX rates) (+2 more)
...
### Community 32 - "Daos.kt"
Cohesion: 0.20
Nodes (3): AccountSum, CategorySum, MerchantMemoryDao
...
### Community 37 - "Period"
Cohesion: 0.50
Nodes (4): Period, Month, Quarter, Year
...
## Knowledge Gaps
- **44 isolated node(s):** `System`, `Dark`, `Light`, `In`, `Out` (+39 more)
...
- **What is the exact relationship between `Laptop Purchase Goal (filename-implied subject)` and `goal_laptop.jpg (moody beach and mountain landscape)`?**
  _Edge tagged AMBIGUOUS (relation: references) - confidence is low._
- **Why does `LedgerState` connect `LedgerState` to `Money.kt`, `MoneyViewModel`, `Txn`, `MoneyRepository`, `MoneyApp.kt`, `TxnDao`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `Flow` connect `Flow` to `Daos.kt`, `LedgerState`, `MoneyViewModel`, `Money.kt`, `MoneyRepository`, `TemplateDao`, `MoneyApp.kt`, `AssetDao`, `BillDao`, `BudgetDao`, `AccountEntity`, `CategoryEntity`, `DebtDao`, `GoalDao`, `LedgerQuery`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `MoneyRepository` connect `MoneyRepository` to `LedgerState`, `MoneyViewModel`, `TemplateDao`, `MoneyApp.kt`, `TxnDao`, `AssetDao`, `BillDao`, `BudgetDao`, `AccountEntity`, `CategoryEntity`, `DebtDao`, `GoalDao`?**
